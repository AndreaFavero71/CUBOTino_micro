...
def init_servo(print_out=s_debug, home_pos=True):
    ...
    if not robot_init_status:                                            # case the inititialization status of the servos false
        ...
        if os.path.exists(fname):                                        # case the servo_settings file exists
            ...
            backup_fname = os.path.join(folder,'Cubotino_m_servo_settings_backup.txt')     # folder and file name for the settings backup
...
def update_parameters():
    ...
    parameters = {'t_servo_close_':t_servo_close, 't_servo_rel_delta_':t_servo_rel,'t_servo_open_':t_servo_open,
                  ...
                  'b_servo_cw_':b_servo_CW, 'b_extra_sides_':b_extra_sides,
                  't_min_pulse_width':t_min_pulse_width, 't_max_pulse_width':t_max_pulse_width,
                  'b_min_pulse_width':b_min_pulse_width, 'b_max_pulse_width': b_max_pulse_width}  # dict of (--tune) parameters
    ...
    while True:                                         # infinite loop
        ...
        if ui == "q" or ui == 'Q' or ui == 'exit':      # cases the imputs are for script quitting
            ...
            try:                                                # tentative
                ...
                print('Command not recognized, double check the command sintax')
